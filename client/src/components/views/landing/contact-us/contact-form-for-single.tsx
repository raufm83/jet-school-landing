          ...
          <div className="flex flex-col gap-4">
            ...
            <div>
              <input
                ...
                className="w-full h-12 px-4 py-3 rounded-[32px] border [@media(min-width:3500px)]:!text-3xl border-jsyellow bg-[#fef7eb]
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center space-y-4 pt-4">
                <h2 className="font-semibold [@media(min-width:3500px)]:!text-3xl text-lg text-jsblack text-center">
                  {t("messageSent")}
                </h2>
                <motion.div
                  initial={{ scale: 0 }}
