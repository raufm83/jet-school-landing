...
export async function generateMetadata({
  ...
  const canonicalUrl = ensureTrailingSlash(`${baseUrl}/${locale}/projects`);
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        az: ensureTrailingSlash(`${baseUrl}/az/projects`),
        ru: ensureTrailingSlash(`${baseUrl}/ru/projects`),
        "x-default": ensureTrailingSlash(`${baseUrl}/az/projects`),
      },
    },
    openGraph,
    twitter: {
